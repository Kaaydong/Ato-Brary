...
public class ImageViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        artistsTextView.setText(convertGsonToNormalString(image.getArtists()));
        copyrightTextView.setText(convertGsonToNormalString(image.getCopyright()));
        charactersTextView.setText(convertGsonToNormalString(image.getCharacters()));
        descriptionsTextView.setText(convertGsonToNormalString(image.getDetails()));
    ...
    public String convertGsonToNormalString(String json)
    {
        String tags = "";

        Type collectionType = new TypeToken<ArrayList<String>>(){}.getType();
        ArrayList<String> tagList = new Gson().fromJson(json, collectionType);
